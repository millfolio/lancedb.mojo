...
struct Store(Movable):
    ...
    def __init__(out self, uri: String, table: String, dim: Int) raises:
        ...
        var uri_c = _cstr(uri)
        var open_fn = self.lib.get_function[def(Int) thin abi("C") -> Int](
            "ldb_open"
        )
    ...
    def delete(self, predicate: String) raises:
        ...
        var f = self.lib.get_function[def(Int, Int) thin abi("C") -> c_int](
            "ldb_delete"
        )
    ...
    def optimize(self) raises:
        ...
        var f = self.lib.get_function[def(Int) thin abi("C") -> c_int](
            "ldb_optimize"
        )
    ...
    def count(self) raises -> Int:
        ...
        var func = self.lib.get_function[def(Int) thin abi("C") -> Int64](
            "ldb_count"
        )
